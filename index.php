<!-- 
   Défauts du code : 
      - Nous n'avons pas créé de fichier séparé pour se connecter à la base de données
      - Nous traitons et affichons les résultats de la requête au même moment que nous les affichons
-->
